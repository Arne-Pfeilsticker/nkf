/*
* Copied from http://plnkr.co/edit/gBDV2ABghTMqqs5YaElB?p=preview
* Slightly modified and adapted.
*/

(function(mdThemeColors) {
    'use strict';

    mdThemeColors.config(['$provide', '$mdThemingProvider', function ($provide, $mdThemingProvider) {
